...
That is the management problem in one paragraph. The agent can do meaningful work, but someone still has to manage the shape of that work.

## What managing the agent looked like

My role in this was to set up coding agents to do the work. What I did:

- Communicated the flow from the user perspective
- Wrote implementation patterns and system requirements and made the agent refer to them
...
- Gap analysis or critical analysis. Believe it or not, it's pretty good. Try it with your personal AI agent and ask what you're doing wrong. Based on the data you've given it, it'll let you know.
